...
public class Track {
	...
	public Track(String trackId, User user, Order order, String address, Date createdTimestamp,
			Date approximatedArrivalDate, Status status, String description, List<History> history) {
		super();
